	...
	\item Enhanced Security and Privacy Protection
	      ...
	      \begin{enumerate}[itemsep=2ex, parsep=1ex]
	      	...
	      	\item Secure Device Registration and Authentication
	      	      ...
	      	      The system implements a robust security mechanism through a predefined `regist' 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{Dashboard_full.png}
...
\begin{enumerate}[itemsep=2ex, parsep=1ex]
	\item TPS chart
	      ...
	      \begin{figure}[h!]
	      	\centering
	      	\includegraphics[width=1\linewidth]{TPSChart.png}
	      	\caption{TPS Chart}
	      	\label{fig:TPSChart}
	      \end{figure}
	...
	\item PK transactions chart
	      ...
	      \begin{figure}[h!]
	      	\centering
	      	\includegraphics[width=1\linewidth]{PKTransactionsChart.png}
	...
	\item Total Transaction\&User Card
	      ...
	      \begin{figure}[h!]
	      	\centering
	      	\includegraphics[width=1\linewidth]{TotalTransactionUserCard.png}
